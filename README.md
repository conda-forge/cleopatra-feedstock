About cleopatra-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cleopatra-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/MAfarrag/cleopatra

Documentation: https://cleopatra.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=16363&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cleopatra-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `cleopatra` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search cleopatra --channel conda-forge

# List packages depending on `cleopatra`:
mamba repoquery whoneeds cleopatra --channel conda-forge
...
Updating cleopatra-feedstock
============================

If you would like to improve the cleopatra recipe or build a new
...
Note that all branches in the conda-forge/cleopatra-feedstock are
